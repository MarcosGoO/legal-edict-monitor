...
const TYPE_LABELS: Record<string, { label: string; color: string }> = {
  radicados: { label: 'Radicados', color: 'bg-indigo-50 text-indigo-700 border-indigo-200' },
  nits:      { label: 'NITs',      color: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
  cedulas:   { label: 'Cédulas',   color: 'bg-amber-50 text-amber-700 border-amber-200' },
  names:     { label: 'Nombres',   color: 'bg-violet-50 text-violet-700 border-violet-200' },
  court_ids: { label: 'Juzgados',  color: 'bg-sky-50 text-sky-700 border-sky-200' },
}
